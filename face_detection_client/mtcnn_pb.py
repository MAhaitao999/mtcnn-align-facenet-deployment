...
class mtcnn(object):
    def __init__(self):
        ...
        self.Pnet_outputs = ['output_1', 'output_2']
        self.Rnet_inputs = ['input_1']
        self.Rnet_outputs = ['output_1', 'output_2']
        self.Onet_inputs = ['input_1']
        self.Onet_outputs = ['output_1', 'output_2', 'output_3']
    ...
    def detectFace(self, img, threshold):
        ...
        for scale in scales:
            ...
            t1 = time.time()
            output = self.triton_client.infer("pnet_tf", inputs=pnet_inputs, outputs=pnet_outputs)
            t2 = time.time()
        ...
        t1 = time.time()
        output = self.triton_client.infer("rnet_tf", inputs=rnet_inputs, outputs=rnet_outputs)
        t2 = time.time()
        ...
        t1 = time.time()
        output = self.triton_client.infer("onet_tf", inputs=onet_inputs, outputs=onet_outputs)
        t2 = time.time()
